...
// var myFriends = ['Hello','Python','JavaScript','Java'];
...
// Array.prototype.indexOf() 🙋‍♂️SS

// Returns the first (least) index of an element within the array equal
// to an element, or -1 if none is found. It search the element from the
// 0th index number

var myFriendNames = ["Hello1", "Python2", "JavaScript3", "Java4"];

console.log(myFriendNames.indexOf("Hello1", 0));
...
console.log(myFriendNames.lastIndexOf("Java4"));
...
console.log(myFriendNames.includes("Python2", 1));
